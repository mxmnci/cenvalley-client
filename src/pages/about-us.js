...
import BackgroundImage, {BackgroundImageClasses,} from "../components/BackgroundImage";
                    ...
                    >
                        <Wrapper>
                            <div className="relative flex flex-col w-full text-center items-center z-10 py-16">
                                ...
                                />
                                <div
                                    className="flex flex-col md:flex-row space-evenly text-white font-semibold w-full space-y-6">
                                    <a
                                        className="flex-grow"
